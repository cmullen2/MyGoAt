...
public:
	...
	void	FillPx(const GTreeParticle& tree, GH1* gHist, Bool_t TaggerBinning = kFALSE);
	void	FillPx(const GTreeParticle& tree, Int_t particle_index, GH1* gHist, Bool_t TaggerBinning = kFALSE);
	void 	FillPx(const GTreeParticle& tree, Int_t particle_index, Int_t tagger_index, GH1* gHist, Bool_t TaggerBinning = kFALSE);

	void	FillPy(const GTreeParticle& tree, GH1* gHist, Bool_t TaggerBinning = kFALSE);
	void	FillPy(const GTreeParticle& tree, Int_t particle_index, GH1* gHist, Bool_t TaggerBinning = kFALSE);
	void 	FillPy(const GTreeParticle& tree, Int_t particle_index, Int_t tagger_index, GH1* gHist, Bool_t TaggerBinning = kFALSE);

	void	FillPz(const GTreeParticle& tree, GH1* gHist, Bool_t TaggerBinning = kFALSE);
	void	FillPz(const GTreeParticle& tree, Int_t particle_index, GH1* gHist, Bool_t TaggerBinning = kFALSE);
	void 	FillPz(const GTreeParticle& tree, Int_t particle_index, Int_t tagger_index, GH1* gHist, Bool_t TaggerBinning = kFALSE);
	...
	// TH1 routines
//Chris Mullen CAM 6/4/16 added the Fill P* and FillE
	void FillPx(const GTreeParticle& tree, TH1* Hprompt, TH1* Hrandom);
	void FillPx(const GTreeParticle& tree, Int_t particle_index, TH1* Hprompt, TH1* Hrandom);
	void FillPx(const GTreeParticle& tree, Int_t particle_index, Int_t tagger_index, TH1* Hprompt, TH1* Hrandom);

	void FillPy(const GTreeParticle& tree, TH1* Hprompt, TH1* Hrandom);
	void FillPy(const GTreeParticle& tree, Int_t particle_index, TH1* Hprompt, TH1* Hrandom);
	void FillPy(const GTreeParticle& tree, Int_t particle_index, Int_t tagger_index, TH1* Hprompt, TH1* Hrandom);

	void FillPz(const GTreeParticle& tree, TH1* Hprompt, TH1* Hrandom);
	void FillPz(const GTreeParticle& tree, Int_t particle_index, TH1* Hprompt, TH1* Hrandom);
	void FillPz(const GTreeParticle& tree, Int_t particle_index, Int_t tagger_index, TH1* Hprompt, TH1* Hrandom);


	void FillE(const GTreeParticle& tree, TH1* Hprompt, TH1* Hrandom);
	void FillE(const GTreeParticle& tree, Int_t particle_index, TH1* Hprompt, TH1* Hrandom);
	void FillE(const GTreeParticle& tree, Int_t particle_index, Int_t tagger_index, TH1* Hprompt, TH1* Hrandom);
