...
void	chrisPPi0Example::ProcessEvent()
{
  ...
  if  (Chamber1_Vec.X()==-1000 || Chamber2_Vec.X()==-1000 ){ //Can I get rid of all events if theres no hit in wc1 cos I wont be able to form the vectors properly.
...
//loop for npidhits
  if (NPidhits>0){
    ...
    if (Chamber1_Vec.X()==-1000 || Chamber2_Vec.X()== -1000 ){
...
//      PIDPhi = -20000;
      ...
      Phidiff = PIDPhi - Chamber1_VecPhi;
